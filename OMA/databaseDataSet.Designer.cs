...
namespace OMA {
    ...
    public partial class databaseDataSet : global::System.Data.DataSet {
        ...
        public partial class usersDataTable : global::System.Data.TypedTableBase<usersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public usersRow AddusersRow(string mail, string password, string name) {
            ...
            public string mail {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'mail\' de la tabla \'users\' es DBNull.", e);
                    }
                }
                set {
...
namespace OMA.databaseDataSetTableAdapters {
    ...
    public partial class usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `users` WHERE ((`Id` = ?) AND ((? = 1 AND `mail` IS NULL) OR (`mail` " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `users` (`mail`, `password`, `name`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `users` SET `mail` = ?, `password` = ?, `name` = ? WHERE ((`Id` = ?) AND (" +
                "(? = 1 AND `mail` IS NULL) OR (`mail` = ?)) AND ((? = 1 AND `password` IS NULL) " +
                "OR (`password` = ?)) AND ((? = 1 AND `name` IS NULL) OR (`name` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::OMA.Properties.Settings.Default.databaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, mail, [password], name FROM users";
        ...
        public virtual int Delete(int Original_Id, string Original_mail, string Original_password, string Original_name) {
        ...
        public virtual int Insert(string mail, string password, string name) {
            if ((mail == null)) {
        ...
        public virtual int Update(string mail, string password, string name, int Original_Id, string Original_mail, string Original_password, string Original_name) {
            if ((mail == null)) {
